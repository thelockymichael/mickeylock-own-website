...
router.post("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, fullName, password, user, passwordCorrect, _b, userForToken, authToken, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 5, , 6]);
                _a = req.body, fullName = _a.fullName, password = _a.password;
            ...
            case 4:
                ...
                authToken = jsonwebtoken_1.default.sign(userForToken, process.env.SECRET);
