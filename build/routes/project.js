...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models_1.Project.find({})];
            case 1:
                project = _a.sent();
...
router.post("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, name_1, tags, description, project, savedProject, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, userId = _a.userId, name_1 = _a.name, tags = _a.tags, description = _a.description;
                project = models_1.Project.build({
                    name: name_1,
            ...
            case 1:
                ...
                // Find user by ID
                return [4 /*yield*/, models_1.User.findOneAndUpdate({ _id: userId }, {
                        $push: { projects: project },
                    })];
            case 2:
                // Find user by ID
                _b.sent();
                return [2 /*return*/, res.status(200).send(savedProject)];
            case 3:
                error_1 = _b.sent();
                next(error_1);
                return [3 /*break*/, 4];
