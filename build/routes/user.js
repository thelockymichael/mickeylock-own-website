...
router.get("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.User.find({}).populate("projects")];
            case 1:
                user = _a.sent();
...
router.get("/:id", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.User.findById(req.params.id).populate("projects")];
            case 1:
                user = _a.sent();
                return [2 /*return*/, user ? res.json(user) : res.status(404).end()];
            case 2:
                error_2 = _a.sent();
                next(error_2);
                return [3 /*break*/, 3];
...
router.post("/register", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var findOneUser, _a, fullName, password, about, profileImage, saltRounds, passwordHash, user, _b, message;
